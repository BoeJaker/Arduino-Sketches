...
const char* ssid     = "BoeJaker";
const char* password = "7370Adalovelace";

#define CMC_API "/v1/ticker/bitcoin/"
#define CMC_URL "sandbox.coinmarketcap.com"

const char* fingerprint = "44e28e84-51e9-4df6-9f2a-4521add711af";
